...
data_root = "/data/repos/w251/v2/week09/hw/data/wm16_de_eb/"

base_params = {
  "use_horovod": False, # jetson doesn't have horovod installed!
  "num_gpus": 1, # when using Horovod we set number of workers with params to mpirun
  "batch_size_per_gpu": 32,  # this size is in sentence pairs, reduce it if you get OOM
  "max_steps": 50000,
  ...
  "logdir": "/data/repos/w251/v2/week09/hw/data/en-de-transformer3/",
...
infer_params = {
  ...
  "data_layer_params": {
    "src_vocab_file": data_root+"m_common.vocab",
    "tgt_vocab_file": data_root+"m_common.vocab",
    "source_file": data_root+"wmt14.tiny.tok",
    "target_file": data_root+"wmt14.tiny.tok",
    "delimiter": " ",
    "shuffle": False,
    "repeat": False,
    "max_length": 256,
